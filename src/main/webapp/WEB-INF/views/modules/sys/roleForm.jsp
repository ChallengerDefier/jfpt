...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			// 用户-医院
			var zNodes2=[
					<c:forEach items="${hospitalList}" var="hospital">{id:"${hospital.id}", pId:"${not empty hospital.parentId?hospital.parentId:0}", name:"${hospital.hospitalName}"},
		            </c:forEach>];
			// 初始化树结构
			var tree2 = $.fn.zTree.init($("#hospitalTree"), setting, zNodes2);
			// 不选择父节点
			tree2.setting.check.chkboxType = { "Y" : "ps", "N" : "s" };
			// 默认选择节点
			var ids2 = "${role.hospitalIds}".split(",");
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<div id="hospitalTree" class="ztree" style="margin-left:100px;margin-top:3px;float:left;"></div>
