...
public class SystemService extends BaseService {
	...
	public Page<User> findUser(Page<User> page, User user) {
		...
		user.getSqlMap().put("dsf", dataScopeFilter(user.getCurrentUser(), "h", "a"));
		// 设置分页参数
		user.setPage(page);
		// 执行分页查询
	...
	public void saveRole(Role role) {
		...
		// 更新角色与部门关联
		roleDao.deleteRoleHospital(role);
		if (role.getHospitalList().size() > 0){
			roleDao.insertRoleHospital(role);
		}
		// 清除用户角色缓存
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://www.sczcd.cn\r\n");
		sb.append("\r\n======================================================================\r\n");
